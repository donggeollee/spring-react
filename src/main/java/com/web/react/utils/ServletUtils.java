...
public class ServletUtils {
	...
	public static ResponseEntity<String> doResponseAsHtml(String htmlBody){
		log.debug("reseponse as html.");
		HttpHeaders httpHeaders = new HttpHeaders();
		httpHeaders.setContentType(org.springframework.http.MediaType.TEXT_HTML);
		return new ResponseEntity( htmlBody , httpHeaders, HttpStatus.OK);
	}
    ...
    public static String getContextPath(HttpServletRequest request){    	
    	...
    	} else if ( request.getContextPath().trim().equals("/") ){
    		return CONTEXT_ROOT_PATH ;    		
    	}else{
